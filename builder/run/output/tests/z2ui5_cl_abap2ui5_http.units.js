// GENERATED from run/input/abap2UI5/src/00/03/z2ui5_cl_abap2ui5_http.clas.testclasses.abap — do not edit
...
class ltcl_test {
  ...
  setup() {
    ...
    this.mo_cut = z2ui5_cl_abap2ui5_http.factory(this.mo_server);
  }
  ...
  test_factory_cloud() {
    const lo_cut = z2ui5_cl_abap2ui5_http.factory_cloud({ req: new ltcl_fake_request(), res: new ltcl_fake_response() });
...
module.exports = {
  __main: "z2ui5_cl_abap2ui5_http",
  __classes: { ltcl_fake_request, ltcl_fake_response, ltcl_fake_server, ltcl_test },
  __tests: {"ltcl_test":["test_factory","test_factory_cloud","test_get_cdata","test_get_header_field","test_set_cdata","test_set_header_field","test_get_response_cookie","test_delete_resp_cookie","test_set_session_stateful"]},
};
