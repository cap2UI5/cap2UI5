...
class z2ui5_cl_core_app {
  ...
  all_xml_stringify() {
    ...
    try {
      ...
      result = z2ui5_cl_util.xml_stringify(this);
    ...
    throw new z2ui5_cx_util_error({ val: `<p>${x.get_text()}<p>Please check if all generic data references are public attributes of your class` });
    return result;
  }
