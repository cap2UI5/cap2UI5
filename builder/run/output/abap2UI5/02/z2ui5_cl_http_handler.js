// TODO(abap2js): unresolved reference z2ui5_cl_a2ui5_http — add require manually
...
class z2ui5_cl_http_handler {
  ...
  static factory({ server, req, res } = {}) {
    ...
    if (server != null) {
      ...
      throw new z2ui5_cx_a2ui5_error({ val: `EMPTY_HTTP_HANDLER_CALL_ERROR` });
    }
    return result;
  }
  ...
  static factory_cloud({ req, res } = {}) {
    let result = null;
    result = new z2ui5_cl_http_handler();
    result.mo_server = z2ui5_cl_a2ui5_http.factory_cloud({ req, res });
    return result;
  }
