 ...
 * builder-cap/run/output/cap2UI5 into the deployable ../cap2UI5/ project.
 *
 * cap2UI5/ is a pure build artifact — it is wiped and rewritten on every
 * publish, so nothing there should be hand-edited (edit builder-cap/base/
...
if (!fs.existsSync(src)) {
  console.error("builder-cap/run/output/cap2UI5 not found — run `npm run assemble` first");
  process.exit(1);
}
