...
class z2ui5_cl_core_srv_bind {
  ...
  bind_tab_cell({ iv_name, iv_val } = {}) {
    ...
    _fs$fs_row = null;
    sy_subrc = 0;
    const lt_attri = z2ui5_cl_a2ui5_context.rtti_get_t_attri_by_any(this.ms_config.tab);
    sy_tabix = 0;
    ...
    throw new z2ui5_cx_a2ui5_error({ val: `BINDING_ERROR_TAB_CELL_LEVEL - No class attribute for binding found - Please check if the bound values are public attributes of your class` });
    return result;
  }

  check_raise_existing() {
    if (this.mr_attri.bind_type !== this.mv_type) {
      throw new z2ui5_cx_a2ui5_error({ val: `<p>Binding Error - Two different binding types for same attribute used (${this.mr_attri.name}).` });
    }
    if (this.mr_attri.custom_mapper != null && this.ms_config.custom_mapper != null && z2ui5_cl_a2ui5_context.rtti_get_classname_by_ref(this.mr_attri.custom_mapper) !== z2ui5_cl_a2ui5_context.rtti_get_classname_by_ref(this.ms_config.custom_mapper)) {
      throw new z2ui5_cx_a2ui5_error({ val: `<p>Binding Error - Two different mappers used for the same attribute (${this.mr_attri.name}).` });
    }
    if (this.mr_attri.custom_mapper_back != null && this.ms_config.custom_mapper_back != null && z2ui5_cl_a2ui5_context.rtti_get_classname_by_ref(this.mr_attri.custom_mapper_back) !== z2ui5_cl_a2ui5_context.rtti_get_classname_by_ref(this.ms_config.custom_mapper_back)) {
      throw new z2ui5_cx_a2ui5_error({ val: `<p>Binding Error - Two different mappers back used for the same attribute (${this.mr_attri.name}).` });
    }
    if (this.mr_attri.custom_filter != null && this.ms_config.custom_filter != null && z2ui5_cl_a2ui5_context.rtti_get_classname_by_ref(this.mr_attri.custom_filter) !== z2ui5_cl_a2ui5_context.rtti_get_classname_by_ref(this.ms_config.custom_filter)) {
      throw new z2ui5_cx_a2ui5_error({ val: `<p>Binding Error - Two different filters used for the same attribute (${this.mr_attri.name}).` });
    }
  }

  check_raise_new() {
    if (!(z2ui5_cl_a2ui5_context.rtti_check_serializable(this.mr_attri.custom_filter_back) === true || z2ui5_cl_a2ui5_context.rtti_check_serializable(this.mr_attri.custom_filter_back) === `X`)) {
      throw new z2ui5_cx_a2ui5_error({ val: `<p>custom_filter_back used but it is not serializable - please use if_serializable_object` });
    }
    if (!(z2ui5_cl_a2ui5_context.rtti_check_serializable(this.mr_attri.custom_mapper_back) === true || z2ui5_cl_a2ui5_context.rtti_check_serializable(this.mr_attri.custom_mapper_back) === `X`)) {
      throw new z2ui5_cx_a2ui5_error({ val: `<p>custom_mapper_back used but it is not serializable - please use if_serializable_object` });
    }
  }
  ...
  main({ val, data, config } = {}) {
    ...
    if (result === `/${z2ui5_if_core_types.cs_ui5.two_way_model}`) {
      throw new z2ui5_cx_a2ui5_error({ val: `<p>Name of variable not allowed - XX is a reserved word - use another name for your attribute` });
    }
