...
class z2ui5_cl_pop_to_select extends z2ui5_if_app {
  ...
  set_output_table() {
    ...
    const ls_sel_tab_type = z2ui5_cl_a2ui5_context.rtti_create_sel_tab_type({ ir_tab: this.mr_tab, add_sel_field: true });
  ...
  on_event_search() {
    ...
    z2ui5_cl_a2ui5_context.itab_filter_by_val({ val: this.client.get_event_arg(1), ignore_case: true, tab: fs_tab_out });
