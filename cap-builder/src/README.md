...
> [framework/README.md](https://github.com/cap2UI5/cap2UI5/blob/main/framework/README.md)
...
the platform-neutral **core package** (`framework/core/`, linked as the npm
dependency `abap2UI5` via `file:../framework/core`) and is generated by the
sync pipeline. All
...
└── package.json      # @sap/cds ^10, "abap2UI5": file-link to framework/core, Node ≥ 22
```

The z2ui5 runtime itself is not part of this project — it comes from the
[core package](../framework/core/) (`require("abap2UI5/engine")`), which `srv/server.js`
...
the transpiler and all other dev tooling live in the repository's `framework/`
folder, see
[framework/README.md](https://github.com/cap2UI5/cap2UI5/blob/main/framework/README.md).
...
[discovery API](../framework/core/srv/app/samples/README.md#discovery-api). The
bundled samples and the framework classes live in the core package
(`../framework/core`), which is owned by the sync pipeline.
