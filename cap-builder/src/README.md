...
> [abap2UI5-js/README.md](https://github.com/cap2UI5/cap2UI5/blob/main/abap2UI5-js/README.md)
...
[`cap-builder/src/`](https://github.com/cap2UI5/cap2UI5/tree/main/cap-builder/src)
...
the platform-neutral **core package** (`abap2UI5-js/core/`, linked as the npm
dependency `abap2UI5` via `file:../abap2UI5-js/core`) and is generated by the
sync pipeline. All
commands below work in both places: in `cap-builder/src/` (source only) and in
...
└── package.json      # @sap/cds ^10, "abap2UI5": file-link to abap2UI5-js/core, Node ≥ 22
```

The z2ui5 runtime itself is not part of this project — it comes from the
[core package](../abap2UI5-js/core/) (`require("abap2UI5/engine")`), which `srv/server.js`
...
the transpiler and all other dev tooling live in the repository's `abap2UI5-js/`
folder, see
[abap2UI5-js/README.md](https://github.com/cap2UI5/cap2UI5/blob/main/abap2UI5-js/README.md).
...
[discovery API](../abap2UI5-js/core/srv/app/samples/README.md#discovery-api). The
bundled samples and the framework classes live in the core package
(`../abap2UI5-js/core`), which is owned by the sync pipeline.
