...
class z2ui5_cl_app_startup extends z2ui5_if_app {
  ...
  view_display_popup() {
    ...
    simple_form2.checkbox({ enabled: false, selected: z2ui5_cl_a2ui5_context.context_check_abap_cloud() });
  ...
  z2ui5_on_event() {
    ...
    switch (this.client.get().EVENT) {
      ...
      case z2ui5_cl_app_startup.cs_event.value_help:
        try {
          this.mt_classes = z2ui5_cl_a2ui5_context.rtti_get_classes_impl_intf(z2ui5_cl_a2ui5_context.rtti_get_intfname_by_ref(li_app));
        } catch (error) {
