 ...
 */
module.exports = {
  // anchored at transpile/ — this suite covers the transpile project (core
  ...
  testPathIgnorePatterns: ["/node_modules/", "/core/app/", "/transpile/base/", "/transpile/run/output/", "/adapter/"],
  // transpile/base/ is the hand-maintained SOURCE of the core package and
  // transpile/run/output/core is the assembled copy — keep both out of module
  // resolution so their package.json / sources never shadow the real
  // transpile/core the tests load.
  modulePathIgnorePatterns: ["/transpile/base/", "/transpile/run/output/core/"],
};
