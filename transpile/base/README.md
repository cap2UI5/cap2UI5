...
| Consumer | How |
|---|---|
| [`cap2UI5/`](../../cap2UI5/) | the full CAP app — `"abap2UI5": "file:../transpile/core"` |
| [`adapter/adapter-cap/`](../adapter/adapter-cap/) | minimal CAP wrapper |
| [`adapter/adapter-node/`](../adapter/adapter-node/) | bare `node:http` server |
| [`adapter/adapter-express/`](../adapter/adapter-express/) | express middleware |
| [`adapter/adapter-web/`](../adapter/adapter-web/) | serverless browser bundle |

> [!IMPORTANT]
> **This folder is a generated build artifact** — assembled from the
> hand-written source in [`transpile/base/`](../base/) plus the transpiled
> upstream [abap2UI5](https://github.com/abap2UI5/abap2UI5) sources. Do not
> hand-edit it; edit `transpile/base/` and re-run `npm run build_core` in
> [`transpile/`](../).
