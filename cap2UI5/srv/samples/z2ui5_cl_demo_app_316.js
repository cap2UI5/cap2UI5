...
class z2ui5_cl_demo_app_316 extends z2ui5_if_app {
  ...
  view_display({ client } = {}) {
    ...
    email_form.input({ id: `inputEmail`, value: client._bind_edit(this.email.email), type: `Email`, placeholder: `Enter email`, class: `sapUiSmallMarginBottom` });
    email_form.input({ id: `inputCcEmail`, value: client._bind_edit(this.email.cc), type: `Email`, placeholder: `Enter cc email`, class: `sapUiSmallMarginBottom` });
    email_form.input({ id: `inputBccEmail`, value: client._bind_edit(this.email.bcc), type: `Email`, placeholder: `Enter bcc email`, class: `sapUiSmallMarginBottom` });
    email_form.label({ text: `Subject`, labelfor: `inputText` });
    email_form.input({ id: `inputText`, value: client._bind_edit(this.email.subject), placeholder: `Enter text`, class: `sapUiSmallMarginBottom` });
    email_form.label(`Mail Body`)
      .text_area({ valueliveupdate: true, value: client._bind_edit(this.email.body), growing: true, growingmaxlines: `7`, width: `100%` });
    ...
    url_form.input({ id: `inputUrl`, value: client._bind_edit(this.url.url), type: `Url`, placeholder: `Enter URL`, class: `sapUiSmallMarginBottom` });
