...
class z2ui5_cl_demo_app_209 extends z2ui5_if_app {
  view_display({ client } = {}) {
    ...
    const layout = page.scroll_container({ vertical: true, height: `100%` })
      ...
      .info_label({ id: `il1`, text: `2`, rendermode: `Narrow`, colorscheme: `1` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 2`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il2`, text: `5`, rendermode: `Narrow`, colorscheme: `2` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 3`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il3`, text: `12.5`, rendermode: `Narrow`, colorscheme: `3` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
      .text({ text: `Color Scheme 4`, class: `sapUiTinyMarginEnd` })
      .info_label({ id: `il4`, text: `2K`, rendermode: `Narrow`, colorscheme: `4` })
      .get_parent()
      .get_parent()
      .flex_box({ direction: `Row`, alignitems: `Start`, class: `sapUiTinyMarginBottom` })
