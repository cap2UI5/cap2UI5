...
class z2ui5_cl_demo_app_285 extends z2ui5_if_app {
  ...
  view_display({ client } = {}) {
    const page_01 = z2ui5_cl_xml_view.factory()
      .shell()
      .page({ title: `abap2UI5 - Sample: Flexible sizing - Icon Tab Bar`, navbuttonpress: client._event_nav_app_leave(), shownavbutton: client.check_app_prev_stack() });
    ...
    const page_02 = page_01.page({ title: `Title`, enablescrolling: true, class: `sapUiResponsivePadding--header sapUiResponsivePadding--footer` })
      .content()
      .vbox({ fitcontainer: true })
      .simple_form({ id: `SimpleFormDisplay480`, editable: false, layout: `ResponsiveGridLayout`, title: `Address`, labelspanl: `4`, labelspanm: `4`, emptyspanl: `0`, emptyspanm: `0`, columnsl: `2`, columnsm: `2` })
      .content(`form`)
      ...
      .get_parent()
      .get_parent()
      .icon_tab_bar({ uppercase: true, expandable: false, applycontentpadding: true, stretchcontentheight: true, class: `sapUiResponsiveContentPadding` })
      .items()
      ...
      .rowmode(`table`)
      .auto({ ns: `trm`, rowcontentheight: `32` })
      .get_parent()
      .get_parent()
      .toolbar({ ns: `table` })
      .overflow_toolbar()
  ...
  popover_display({ id } = {}) {
    ...
    view.quick_view({ placement: `Bottom`, width: `auto` })
      .quick_view_page({ pageid: `sampleInformationId`, header: `Sample information`, description: `This page shows flexible sizing with an Icon Tab Bar: ` + `The upper part extends with its content, but doesn't react to viewport changes. ` + `The Icon Tab Bar reacts to the viewport size. ` + `The table inside takes the available space. ` + `If the minimum size of the table is reached, the page begins to scroll.` });
