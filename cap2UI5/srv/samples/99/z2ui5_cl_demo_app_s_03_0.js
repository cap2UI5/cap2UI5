...
class z2ui5_cl_demo_app_s_03_0 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    vbox.message_strip({ text: this.client._bind(this.message.text, { name: `message-text` }), type: this.client._bind(this.message.type, { name: `message-type` }), visible: `{= !!$` + this.client._bind(this.message.text, { name: `message-text` }) + ` }` });
