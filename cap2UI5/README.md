...
> [builder-abap2UI5-js/README.md](https://github.com/cap2UI5/cap2UI5/blob/main/builder-abap2UI5-js/README.md)
...
[`builder-cap2UI5/src/`](https://github.com/cap2UI5/cap2UI5/tree/main/builder-cap2UI5/src)
...
the platform-neutral **core package** (`builder-abap2UI5-js/core/`, linked as the npm
dependency `abap2UI5` via `file:../builder-abap2UI5-js/core`) and is generated by the
sync pipeline. All
commands below work in both places: in `builder-cap2UI5/src/` (source only) and in
...
└── package.json      # @sap/cds ^10, "abap2UI5": file-link to builder-abap2UI5-js/core, Node ≥ 22
```

The z2ui5 runtime itself is not part of this project — it comes from the
[core package](../builder-abap2UI5-js/core/) (`require("abap2UI5/engine")`), which `srv/server.js`
...
the transpiler and all other dev tooling live in the repository's `builder-abap2UI5-js/`
folder, see
[builder-abap2UI5-js/README.md](https://github.com/cap2UI5/cap2UI5/blob/main/builder-abap2UI5-js/README.md).
...
[discovery API](../builder-abap2UI5-js/core/srv/app/samples/README.md#discovery-api). The
bundled samples and the framework classes live in the core package
(`../builder-abap2UI5-js/core`), which is owned by the sync pipeline.
