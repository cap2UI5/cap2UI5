 ...
 */
module.exports = {
  // anchored at builder-abap2UI5-js/ — this suite covers the transpile project (core
  ...
  testPathIgnorePatterns: ["/node_modules/", "/core/app/", "/builder-abap2UI5-js/src/", "/builder-abap2UI5-js/run/output/", "/adapters/"],
  // builder-abap2UI5-js/src/ is the hand-maintained SOURCE of the core package and
  // builder-abap2UI5-js/run/output/core is the assembled copy — keep both out of module
  // resolution so their package.json / sources never shadow the real
  // builder-abap2UI5-js/core the tests load.
  modulePathIgnorePatterns: ["/builder-abap2UI5-js/src/", "/builder-abap2UI5-js/run/output/core/"],
};
