...
class z2ui5_cl_demo_app_457 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    page.vbox(`sapUiSmallMargin`)
      .date_picker({ displayformat: `long`, datevalue: `{ path: '${this.client._bind_edit(this.date_iso, { path: true })}', ` + `formatter: 'Formatter.DateCreateObject' }` })
      .text({ text: `Model value (unchanged string): ${this.client._bind_edit(this.date_iso)}`, class: `sapUiTinyMarginTop` });
