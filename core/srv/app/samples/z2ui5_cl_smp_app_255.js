...
class z2ui5_cl_smp_app_255 extends z2ui5_if_app {
  ...
  view_display({ client } = {}) {
    ...
    page.tag(`MessageStrip`)
      .a({ n: `text`, v: `Navigation layouts built with sap.m.FlexBox and own CSS classes: variable width, equal width with ` + `a transition effect and a wrapping row. The hint button in the header explains each panel.` })
