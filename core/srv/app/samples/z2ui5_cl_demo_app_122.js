...
class z2ui5_cl_demo_app_122 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    page.simple_form({ title: `Information`, editable: true })
      ...
      .input({ value: this.client._bind_edit(this.device_browser), enabled: false })
      .label(`device_browser_version`)
      .input({ value: this.client._bind_edit(this.device_browser_version), enabled: false })
      .label(`device_os`)
      .input({ value: this.client._bind_edit(this.device_os), enabled: false })
      .label(`device_os_version`)
      .input({ value: this.client._bind_edit(this.device_os_version), enabled: false })
      .label(`device_systemtype`)
      .input({ value: this.client._bind_edit(this.device_systemtype), enabled: false })
      .label(`device_orientation`)
      .input({ value: this.client._bind_edit(this.device_orientation), enabled: false })
      .label(`device_height`)
      .input({ value: this.client._bind_edit(this.device_height), enabled: false })
      .label(`device_width`)
      .input({ value: this.client._bind_edit(this.device_width), enabled: false })
      .label(`device_phone`)
      .input({ value: this.client._bind_edit(this.device_phone), enabled: false })
      .label(`device_desktop`)
      .input({ value: this.client._bind_edit(this.device_desktop), enabled: false })
      .label(`device_tablet`)
      .input({ value: this.client._bind_edit(this.device_tablet), enabled: false })
      .label(`device_combi`)
      .input({ value: this.client._bind_edit(this.device_combi), enabled: false })
      .label(`device_touch`)
      .input({ value: this.client._bind_edit(this.device_touch), enabled: false })
      .label(`device_pointer`)
      .input({ value: this.client._bind_edit(this.device_pointer), enabled: false })
      .label(`device_retina`)
      .input({ value: this.client._bind_edit(this.device_retina), enabled: false })
      .label(`ui5_version`)
      .input({ value: this.client._bind_edit(this.ui5_version), enabled: false })
      .label(`ui5_theme`)
      .input({ value: this.client._bind_edit(this.ui5_theme), enabled: false })
      .label(`ui5_gav`)
      .input({ value: this.client._bind_edit(this.ui5_gav), enabled: false })
      .label(`ui5_build_timestamp`)
      .input({ value: this.client._bind_edit(this.ui5_build_timestamp), enabled: false });
