...
/**
 * z2ui5_cl_ui5f_style_css — JS port of abap2UI5 z2ui5_cl_ui5f_style_css.
 *
 * abap holds the source as an ABAP string template; in CAP the file lives on
 * disk under app/z2ui5/webapp/css/style.css and is normally served by CAP's
 ...
 */
class z2ui5_cl_ui5f_style_css {

  static MIME = "text/css";
  static ASSET_PATH = "css/style.css";

  /** Returns the file content as a string (or null if missing). */
  static get_source() {
    return z2ui5_asset.read(z2ui5_cl_ui5f_style_css.ASSET_PATH);
  }
   ...
   */
  static get(...args) {
    return z2ui5_cl_ui5f_style_css.get_source(...args);
  }
}

module.exports = z2ui5_cl_ui5f_style_css;
