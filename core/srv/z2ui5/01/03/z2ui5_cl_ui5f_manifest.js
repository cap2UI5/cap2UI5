...
/**
 * z2ui5_cl_ui5f_manifest — JS port of abap2UI5 z2ui5_cl_ui5f_manifest.
 *
...
class z2ui5_cl_ui5f_manifest {
  ...
  static get_source() {
    return z2ui5_asset.read(z2ui5_cl_ui5f_manifest.ASSET_PATH);
  }
   ...
   */
  static get(...args) {
    return z2ui5_cl_ui5f_manifest.get_source(...args);
  }
}

module.exports = z2ui5_cl_ui5f_manifest;
