...
/**
 * z2ui5_cl_ui5f_server_js — JS port of abap2UI5 z2ui5_cl_ui5f_server_js.
 *
 * abap holds the source as an ABAP string template; in CAP the file lives on
 * disk under app/z2ui5/webapp/core/Server.js and is normally served by CAP's
 ...
 */
class z2ui5_cl_ui5f_server_js {

  static MIME = "application/javascript";
  static ASSET_PATH = "core/Server.js";

  /** Returns the file content as a string (or null if missing). */
  static get_source() {
    return z2ui5_asset.read(z2ui5_cl_ui5f_server_js.ASSET_PATH);
  }
   ...
   */
  static get(...args) {
    return z2ui5_cl_ui5f_server_js.get_source(...args);
  }
}

module.exports = z2ui5_cl_ui5f_server_js;
