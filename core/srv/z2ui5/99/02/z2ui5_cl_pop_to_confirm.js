...
class z2ui5_cl_pop_to_confirm extends z2ui5_if_app {
  ...
  result() {
    let result = false;
    result = z2ui5_cl_util.abap_tab_assign(result, z2ui5_cl_util.abap_copy(this.check_result_confirmed));
    return result;
  }
  ...
  static factory({ i_question_text, i_title = `Popup To Confirm`, i_icon = `sap-icon://question-mark`, i_button_text_confirm = `OK`, i_button_text_cancel = `Cancel`, i_event_confirm = z2ui5_cl_pop_to_confirm.cs_event.confirmed, i_event_cancel = z2ui5_cl_pop_to_confirm.cs_event.canceled } = {}) {
    ...
    r_result.icon = z2ui5_cl_util.abap_tab_assign(r_result.icon, z2ui5_cl_util.abap_copy(i_icon));
    r_result.question_text = z2ui5_cl_util.abap_tab_assign(r_result.question_text, z2ui5_cl_util.abap_copy(i_question_text));
    ...
    r_result.event_confirm = z2ui5_cl_util.abap_tab_assign(r_result.event_confirm, z2ui5_cl_util.abap_copy(i_event_confirm));
    r_result.event_canceled = z2ui5_cl_util.abap_tab_assign(r_result.event_canceled, z2ui5_cl_util.abap_copy(i_event_cancel));
    return r_result;
  }
  ...
  async main(client) {
    ...
    switch (client.get().EVENT) {
      case `BUTTON_CONFIRM`:
        ...
        client.nav_app_leave(client.get_app_prev(), this.event_confirm);
        break;
      case `BUTTON_CANCEL`:
        this.check_result_confirmed = false;
        client.popup_destroy();
        client.nav_app_leave(client.get_app_prev(), this.event_canceled);
        break;
    }
  }
}
...
require("abap2UI5/z2ui5_pop_preferred_param")(z2ui5_cl_pop_to_confirm, {
