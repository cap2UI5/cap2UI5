...
class z2ui5_cl_pop_to_inform extends z2ui5_if_app {
  ...
  static factory({ i_text, i_title = `Information`, i_icon = `sap-icon://information`, i_button_text = `OK` } = {}) {
    ...
    r_result.button_text_confirm = z2ui5_cl_util.abap_tab_assign(r_result.button_text_confirm, z2ui5_cl_util.abap_copy(i_button_text));
    return r_result;
  }
...
require("abap2UI5/z2ui5_pop_preferred_param")(z2ui5_cl_pop_to_inform, {
  factory: { preferred: `i_text`, params: [`i_text`, `i_title`, `i_icon`, `i_button_text`] },
});
