...
| Consumer | How |
|---|---|
| [`cap2UI5/`](../../cap2UI5/) | the full CAP app — `"abap2UI5": "file:../framework/core"` |
...
> hand-written source in [`framework/src/`](../src/) plus the transpiled
> upstream [abap2UI5](https://github.com/abap2UI5/abap2UI5) sources. Do not
> hand-edit it; edit `framework/src/` and re-run `npm run build_core` in
> [`framework/`](../).
