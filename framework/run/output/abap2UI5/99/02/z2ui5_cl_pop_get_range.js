...
class z2ui5_cl_pop_get_range extends z2ui5_if_app {
  ...
  static factory({ t_range } = {}) {
    ...
    z2ui5_cl_a2ui5_context.itab_corresponding({ val: t_range, tab: r_result.ms_result.t_range });
  ...
  async main(client) {
    ...
    if (client.check_on_init()) {
      this.mt_mapping = z2ui5_cl_a2ui5_context.filter_get_token_range_mapping();
      this.mt_filter = [];
      sy_tabix = 0;
      for (const lr_range of this.ms_result.t_range) {
        sy_tabix++;
        this.mt_filter.push({ low: lr_range.low, high: lr_range.high, option: lr_range.option, key: z2ui5_cl_a2ui5_context.uuid_get_c32() });
      }
      this.view_display();
      return;
    }
    switch (client.get().EVENT) {
      ...
      case `BUTTON_CANCEL`:
        ...
        break;
      case `POPUP_ADD`:
        this.mt_filter.push({ key: z2ui5_cl_a2ui5_context.uuid_get_c32() });
