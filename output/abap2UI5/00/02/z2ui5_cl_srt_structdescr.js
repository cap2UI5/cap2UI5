...
class z2ui5_cl_srt_structdescr extends z2ui5_cl_srt_complexdescr {
  ...
  constructor({ rtti } = {}) {
    ...
    for (const fs_component of components_rtti) {
      sy_tabix++;
      scomponent = null;
      scomponent.name = fs_component.name;
      scomponent_rtti = z2ui5_cl_srt_datadescr.create_by_rtti(fs_component.type);
      scomponent.type = scomponent_rtti;
      scomponent.as_include = fs_component.as_include;
      scomponent.suffix = fs_component.suffix;
  ...
  get_rtti() {
    ...
    for (const fs_component of this.components) {
      sy_tabix++;
      component_rtti = null;
      component_rtti.name = fs_component.name;
      try {
      ...
      component_rtti.as_include = fs_component.as_include;
      component_rtti.suffix = fs_component.suffix;
