...
class z2ui5_cl_exit {
  ...
  static get_user_exit_class() {
    ...
    try {
      ...
      r_class_name = (exit_classes[(1) - 1].classname optional);
    } catch (error) {
    }
    return r_class_name;
  }
  ...
  set_config_http_get() {
    ...
    if (z2ui5_cl_exit.gi_user_exit != null) {
      z2ui5_cl_exit.gi_user_exit.set_config_http_get(/* TODO(abap2js): out-params */ EXPORTING is_context = context CHANGING cs_config = cs_config);
    }
  }
  ...
  set_config_http_post() {
    ...
    if (z2ui5_cl_exit.gi_user_exit != null) {
      z2ui5_cl_exit.gi_user_exit.set_config_http_post(/* TODO(abap2js): out-params */ EXPORTING is_context = context CHANGING cs_config = cs_config);
    }
  ...
  static init_context({ http_info } = {}) {
    ...
    z2ui5_cl_exit.context.app_start = (http_info.t_params.find((row) => row.n === `app_start`).v optional);
  }
}
