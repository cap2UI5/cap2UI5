...
class z2ui5_cl_xml_view_cc {
  ...
  camera_picture({ id, value, thumbnail, height, width, press, autoplay, onphoto, facingmode, deviceid } = {}) {
    let result = null;
    result = this.mo_view;
    this.mo_view._generic({ name: `CameraPicture`, ns: `z2ui5`, t_prop: [{ n: `id`, v: id }, { n: `value`, v: value }, { n: `thumbnail`, v: thumbnail }, { n: `press`, v: press }, { n: `height`, v: height }, { n: `width`, v: width }, { n: `OnPhoto`, v: onphoto }, { n: `autoplay`, v: z2ui5_cl_util.boolean_abap_2_json(autoplay) }, { n: `facingMode`, v: facingmode }, { n: `deviceId`, v: deviceid }] });
    return result;
  }
  ...
  timer({ finished, delayms, checkrepeat, checkactive } = {}) {
    let result = null;
    result = this.mo_view;
    this.mo_view._generic({ name: `Timer`, ns: `z2ui5`, t_prop: [{ n: `delayMS`, v: delayms }, { n: `finished`, v: finished }, { n: `checkActive`, v: z2ui5_cl_util.boolean_abap_2_json(checkactive) }, { n: `checkRepeat`, v: z2ui5_cl_util.boolean_abap_2_json(checkrepeat) }] });
    return result;
  }
  ...
  websocket({ value, received, path, checkrepeat, checkactive } = {}) {
    let result = null;
    result = this.mo_view;
    this.mo_view._generic({ name: `Websocket`, ns: `z2ui5`, t_prop: [{ n: `value`, v: value }, { n: `path`, v: path }, { n: `received`, v: received }, { n: `checkActive`, v: z2ui5_cl_util.boolean_abap_2_json(checkactive) }, { n: `checkRepeat`, v: z2ui5_cl_util.boolean_abap_2_json(checkrepeat) }] });
    return result;
  }
  ...
  lp_title({ title, applicationfullwidth } = {}) {
    let result = null;
    result = this.mo_view;
    this.mo_view._generic({ name: `LPTitle`, ns: `z2ui5`, t_prop: [{ n: `title`, v: title }, { n: `ApplicationFullWidth`, v: z2ui5_cl_util.boolean_abap_2_json(applicationfullwidth) }] });
    return result;
  }
  ...
  dirty({ isdirty } = {}) {
    let result = null;
    result = this.mo_view;
    this.mo_view._generic({ name: `Dirty`, ns: `z2ui5`, t_prop: [{ n: `isDirty`, v: z2ui5_cl_util.boolean_abap_2_json(isdirty) }] });
    return result;
  }
