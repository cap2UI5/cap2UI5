...
class z2ui5_cl_demo_app_172 extends z2ui5_if_app {
  ...
  on_event() {
    ...
    switch (this.client.get().EVENT) {
      case `LINK_CLICK`:
        lv_tab_index = z2ui5_cl_util.abap_copy(lt_event_arguments[(1) - 1]);
      ...
      case `INPUT_CHANGE`:
        ...
        ls_row_submit = z2ui5_cl_util.abap_copy(this.output[(lv_tab_index) - 1]);
        lv_id_parent = z2ui5_cl_util.abap_copy(lt_event_arguments[(3) - 1]);
        lv_column = z2ui5_cl_util.abap_copy(lt_event_arguments[(4) - 1]);
  ...
  render_main_screen() {
    ...
    const table = page.ui_table({ id: `tab`, alternaterowcolors: `true`, selectionmode: `None`, rows: this.client._bind_edit(this.output) });
  ...
  calculate_sum({ i_column } = {}) {
    ...
    fs_f_input = _fs$fs_f_input ? _fs$fs_f_input.o[_fs$fs_f_input.k] : null;
    sy_subrc = _fs$fs_f_input ? 0 : 4;
    fs_f_input = z2ui5_cl_util.abap_copy(lv_sum);
