...
class z2ui5_cl_demo_app_141 extends z2ui5_if_app {
  ...
  popup_display() {
    ...
    dialog.content()
      ...
      .input(this.client._bind_edit(this.ms_popup_input.value1, { name: `ms_popup_input-value1` }))
      .label(`Input2`)
      .input(this.client._bind_edit(this.ms_popup_input.value2, { name: `ms_popup_input-value2` }))
      .label(`Checkbox`)
      .checkbox({ selected: this.client._bind_edit(this.ms_popup_input.check_is_active, { name: `ms_popup_input-check_is_active` }), text: `this is a checkbox`, enabled: true })
      .get_parent()
      .get_parent()
      .footer()
      .overflow_toolbar()
  ...
  view_display() {
    ...
    const script = `` + `z2ui5.setBlackColor = function() {` + ` ` + ` var lbl = sap.ui.getCore()
      .byId('popupId--lbl1');` + ` ` + ` lbl.setText('changed from js');` + ` ` + ` lbl.addStyleClass('lbl-color');` + ` ` + `};`;
