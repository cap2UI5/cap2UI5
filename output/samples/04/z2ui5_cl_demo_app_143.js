...
class z2ui5_cl_demo_app_143 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    const table = cont.vbox()
      .ui_table({ rows: this.client._bind(this.gt_data), id: `Table1`, editable: false, alternaterowcolors: true, enablecellfilter: true, rowactioncount: `1`, fixedcolumncount: `1`, selectionmode: `None` });
    table.rowmode(`table`).fixed({ ns: `trm`, rowcount: `7` });
    table.ui_columns()
