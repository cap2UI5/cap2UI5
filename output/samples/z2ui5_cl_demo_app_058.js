...
class z2ui5_cl_demo_app_058 extends z2ui5_if_app {
  ...
  popup_display_view() {
    ...
    lo_tab.tab({ text: `Table`, selected: this.client._bind_edit(this.mv_check_table) })
      ...
      .content(`form`)
      .label(`zebra mode`)
      .checkbox(this.client._bind_edit(this.ms_layout.check_zebra))
      .label(`sticky header`)
      .input(this.client._bind_edit(this.ms_layout.sticky_header))
      .label(`Title`)
      .input(this.client._bind_edit(this.ms_layout.title))
      .label(`sel mode`)
      .combobox({ selectedkey: this.client._bind_edit(this.ms_layout.selmode), items: this.client._bind(this.mt_combo) })
      .item({ key: `{KEY}`, text: `{TEXT}` });
    lo_tab.tab({ text: `Columns`, selected: this.client._bind(this.mv_check_columns) })
      .table(this.client._bind_edit(this.ms_layout.t_cols))
      .columns()
      .column()
      .text(`Visible`)
      .get_parent()
