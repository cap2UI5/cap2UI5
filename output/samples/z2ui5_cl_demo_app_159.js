...
class z2ui5_cl_demo_app_159 extends z2ui5_if_app {
  ...
  view_display() {
    ...
    view.shell()
      .page({ title: `abap2UI5 - Popup Display PDF`, navbuttonpress: this.client._event_nav_app_leave(), shownavbutton: this.client.check_app_prev_stack() })
