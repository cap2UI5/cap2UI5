...
class z2ui5_cl_demo_app_240 extends z2ui5_if_app {
  ...
  view_display({ client } = {}) {
    ...
    const layout = page.vbox(`sapUiSmallMargin`)
      ...
      .get_parent()
      .get_parent()
      .switch_({ state: true, enabled: false })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      ...
      .get_parent()
      .hbox()
      .switch_({ state: true, customtexton: `Yes`, customtextoff: `No` })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      .get_parent()
      .switch_({ state: false, customtexton: `Yes`, customtextoff: `No` })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      .get_parent()
      .switch_({ state: true, customtexton: `Yes`, customtextoff: `No`, enabled: false })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      ...
      .get_parent()
      .hbox()
      .switch_({ state: true, customtexton: ` `, customtextoff: ` ` })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      .get_parent()
      .switch_({ state: false, customtexton: ` `, customtextoff: ` ` })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      .get_parent()
      .switch_({ state: true, customtexton: ` `, customtextoff: ` `, enabled: false })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      ...
      .get_parent()
      .hbox()
      .switch_({ type: `AcceptReject`, state: true })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      .get_parent()
      .switch_({ type: `AcceptReject` })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` })
      .get_parent()
      .get_parent()
      .switch_({ type: `AcceptReject`, state: true, enabled: false })
      .get()
      .layout_data()
      .flex_item_data({ growfactor: `1` });
