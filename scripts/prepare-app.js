#!/usr/bin/env node
/**
 * prepare-app — step 5: builds the ready-to-serve frontend into output/app.
 * Takes input/abap2UI5/app/webapp 1:1 and applies the two cap2UI5-specific
 * patches (see patch-frontend.js). The copy step (copy-into-cap.js) then
 * just copies output/app into the CAP project like the other output folders.
 *
...
console.log(`output/app prepared from input/abap2UI5/app/webapp`);
